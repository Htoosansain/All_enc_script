...
os.system("xdg-open https://t.me/Myanmar_anonymous_helper_team")
...
logo = """
 ...
 \033[1;32m       (____/  \033[1;33m                    |_|               
     ...
     \033[1;33mCreated By Myanmar Anonymous Helper Team \033[1;37m( \033[1;33mZ4l_hydr4\033[1;37m )
...
if mainmenu == "1" or mainmenu == "01":
    ...
    m = marshal.dumps(a)
    s = repr(m)
    b = '# Create by Py Compile\n# Created by HtooSanSain (https://github.com/Htoosansain)\n#  youtube channel :    https://www.youtube.com/@z4l-Hydr4.htoosansain\n\nimport marshal\nexec(marshal.loads(' + s + '))'
    d = open(c, 'w')
    d.write(b)
    d.close()
    time.sleep(3)
